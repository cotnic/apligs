...
insert into zvrst (id_zvrst, zv_naziv) values (0, 'reggae');
...
insert into instrument (id_instrument, in_naziv) values (0, 'klavir');

insert into vloga (id_vloga, vl_naziv) values (0, 'pevec');

insert into vloga (id_vloga, vl_naziv) values (1, 'kitarist');
...
insert into uporabnik (id_uporabnik, postna_stevilka, id_vloga, up_ime, up_priimek, up_email, up_ustvarjen) values (1, 2000, 0, 'Rok', 'Solar', 'rs0424@student.uni-lj.si', '2016-11-22');
...
insert into uporabnik (id_uporabnik, postna_stevilka, id_vloga, up_ime, up_priimek, up_email, up_ustvarjen) values (3, 3301, 0, 'Andrej', 'Kokelj', 'ak1729@student.uni-lj.si', CURDATE());

insert into uporabnik (id_uporabnik, postna_stevilka, id_vloga, up_ime, up_priimek, up_email, up_ustvarjen) values (0, 1290, 4, 'Miha', 'Lampret', 'ml0043@student.uni-lj.si', '2016-11-19');
...
insert into igra (id_instrument, id_uporabnik) values (0, 0);

insert into izvaja (id_zvrst, id_uporabnik) values (2, 2);

insert into izvaja (id_zvrst, id_uporabnik) values (1, 1);

insert into izvaja (id_zvrst, id_uporabnik) values (4, 4);

insert into izvaja (id_zvrst, id_uporabnik) values (0, 3);

insert into izvaja (id_zvrst, id_uporabnik) values (3, 0);
...
insert into sporocilo (id_sporocila, id_poslje, id_prejme, sp_zadeva, sp_vsebina, sp_poslano) values (0, 3, 1, 'Kritika', 'Niste glih najboljsi', '2016-12-13');

insert into oglas (id_oglas, id_vloga, id_uporabnik, id_zvrst, og_naslov, og_objavljen, og_opis, og_premium) values (4, 0, 4, 0, 'Ansambel', '2016-12-1', 'Iscemo pevca za v ansambel!', 1);

insert into oglas (id_oglas, id_vloga, id_uporabnik, id_zvrst, og_naslov, og_objavljen, og_opis, og_premium) values (0, 2, 1, 2, 'Pevec', '2016-12-1', 'Iscemo pevca za petje v duetu!', 0);
...
insert into oglas (id_oglas, id_vloga, id_uporabnik, id_zvrst, og_naslov, og_objavljen, og_opis, og_premium) values (3, 0, 2, 0, 'Back vocal', '2016-12-1', 'Iscemo back vocal za pop skupino', 0);

insert into oglas (id_oglas, id_vloga, id_uporabnik, id_zvrst, og_naslov, og_objavljen, og_opis, og_premium) values (1, 2, 3, 0, 'Rock-punk', '2016-12-1', 'Iscemo pianista za jazz skupino', 0);
